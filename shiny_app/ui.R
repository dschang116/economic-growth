...
# Define ten biggest economies then order alphabetically
...
shinyUI(
  navbarPage(
        ...
        fluidRow(
          ...
          column(
            ...
            p(
              ...
              variabiliy in different economic measures and policy actions."),
    ...
    tabPanel(
      ...
      p(
        "The Federal Reserve Economic Data (FRED), along with datasets from the Institute for Mergers, Acquisitions and 
        Alliances (IMAA), the U.S. Patent and Trademark Office (USPTO), Yahoo! Finance, and Macrotrends, have 
        an abundance of annualized economic data from 1988-2018 that can be used to draw conclusions about 
        correlations between different trends."),
      ...
      p("Of particular interest are the relations among consumer  welfare, private sector 
        ...
        Growth"), "and", strong("Real GDP per Capita."), "Business environments are captured by", strong("Corporate Profits after Tax, 
        the S&P 500 Index, and the Number of Patents Granted;"), "all are indicators of the level of productivity, 
        intellectual innovation, or a combination of the two. The public sector plays an important role in 
        impacting the", strong("Trade Balance"), "as well as", strong("Mergers and Acquistion,"), " both of which are parameters we can 
    ...
    tabPanel(
      ...
      p(
        "We now turn to understand the economy in era of COVID-19. The Trump Administration's response
        to the pandemic has largely been a decentralized approach in respect to public policy, 
        granting the governors' much authority individual states' actions and measures."),
      
      p("The map below
        shows the different challenges and responses of each governor faced, as well as his or her
        relative success both in terms of managing the pandemic and minimizing negative economic 
        effects. It is important to keep in mind the nuances and uniqueness of each state and 
        the challenges they face, as such considerations may not be reflected in the map."),
    ...
    tabPanel(
      ...
      p("The WEI can be used to assess rapidly changing economic conditions and the overall
        health of the U.S. economy amidst the the pandemic. Use the dashboard to adjust the parameters of 
       ...
       p("The model and the 95% confidence interval for the WEI is shown below. From the coefficients,
        we see that."),
      ...
      sidebarLayout(
        ...
        mainPanel(plotOutput("wei_posterior"),
                  fluidPage(
                    withMathJax(),
                    helpText("The formula is index ~ week + new_deaths + claims")))
      )
    ),
    ...
    tabPanel(
      ...
      p(
        ...
        mantaining a strong economy amidst a public health crisis. This project seeks to contexualize
      ...
      p(
        ...
        primarily dependent on the country's appraoch to managing the pandemic and the development of an 
        effective vaccine."
      ),
      p(
      ...
      p(
        ...
        tags$ol(
          tags$li(
            ...
            "provides data on U.S. coporate profits, initial unemployment claims, real GDP growth, and real 
            GDP per capita."
          ),
          tags$li(
          ...
          tags$li(
            ...
            "provides data on real GDP growth for world's 
            advanced economies."
          ),
          tags$li(
